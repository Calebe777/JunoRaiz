...
// Custom Branded Cursor Logic
const dot = document.getElementById('cursorDot');
const circle = document.getElementById('cursorCircle');

if (dot && circle && matchMedia('(pointer: fine)').matches) {
  ...
  const hoverSelectors = 'a, button, input, textarea, .svc, .proj, .qbtn, .about-card, .menu-btn';
